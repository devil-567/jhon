        ...
        <a href="#" onClick={clickBack}>&#8249;</a>
                ...
                <div className='middle'>
                  ...
                  <div className='middle_ander'>
                        <div className='left'>
                            <img src={prifile_photo2}/>
                              <span>Rakul Preet Singh</span>
                              <div className='brandname'>
                              <FontAwesomeIcon icon={faYoutube} className="icon"/>
                                <span className="brand__name">Smart Girl</span>

                              </div>
                        </div>
                        <div className='right'>
                            <p><FontAwesomeIcon icon={faYoutube} className="icon"/> Watch Testimonial</p>
                            Rakul Preet Singh was born on 10 October 1990 in a Sikh family in New Delhi.[4][5][6] Rakul did her
                             schooling from Army Public School, Dhaula Kuan and later completed a degree in  
                             and Mary College.[7][8] [9] Her mother is Rajender Kaur and father is 
                             Kulwinder Singh.<br/><br/>
                            <span>Read More..</span>
                        </div>
