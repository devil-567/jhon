        ...
        <a href="#" onClick={clickBack}>&#8249;</a>
                ...
                <div className='middle'>
                  ...
                  <div className='middle_ander'>
                        <div className='left'>
                            <img src={prifile_photo4}/>
                              <span>janhvi Kapoor</span>
                              <div className='brandname'>
                              <FontAwesomeIcon icon={faSquareEnvelope} className="icon"/>
                                <span className="brand__name">Generl Manager</span>

                              </div>
                        </div>
                        <div className='right'>
                            <p><FontAwesomeIcon icon={faYoutube} className="icon"/> Watch Testimonial</p>
                            janhvi Kapoor (born 6 March 1997) is an Indian actress who works in Hindi films. Born 
                            to Sridevi and Boney Kapoor, she made her acting debut in 2018 with the romantic drama Dhadak,
                            
                             which was a commercial success. Kapoor went on to receive a nomination for the Filmfare Award
                              for Best <br/><br/>
                            <span>Read More..</span>
                        </div>
