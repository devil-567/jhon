        ...
        <a href="#" onClick={clickBack}>&#8249;</a>
                ...
                <div className='middle'>
                  ...
                  <div className='middle_ander'>
                        <div className='left'>
                            <img src={prifile_photo6}/>
                              <span>Raashii Khanna</span>
                              <div className='brandname'>
                              <FontAwesomeIcon icon={faSquareEnvelope} className="icon"/>
                                <span className="brand__name">South Actress</span>

                              </div>
                        </div>
                        <div className='right'>
                            <p><FontAwesomeIcon icon={faYoutube} className="icon"/> Watch Testimonial</p>
                            Raashii Khanna (born 30 November 1990) is an Indian actress and playback singer who
                             predominantly works in Telugu and Tamil film industries. She made her acting debut 
                             in a supporting role with the Hindi film Madras Cafe (2013)  <br/><br/>
                            <span>Read More..</span>
                        </div>
