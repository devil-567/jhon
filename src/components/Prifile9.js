        ...
        <a href="#" onClick={clickBack}>&#8249;</a>
                ...
                <div className='middle'>
                  ...
                  <div className='middle_ander'>
                        <div className='left'>
                            <img src={prifile_photo7}/>
                              <span>Samanta</span>
                              <div className='brandname'>
                              <FontAwesomeIcon icon={faSquareEnvelope} className="icon"/>
                                <span className="brand__name">Emotional Actress</span>

                              </div>
                        </div>
                        <div className='right'>
                            <p><FontAwesomeIcon icon={faYoutube} className="icon"/> Watch Testimonial</p>
                            Samanta was a title and position used in the history of the Indian subcontinent between 4th
                             and 12th century to denote a vassal ortributary chief. The term roughly translates to neighbor.
                              The institution is considered to be closely associated with the origin and growth of feudalism in
                                Medieval India.
                            <br/><br/>
                            <span>Read More..</span>
                        </div>
