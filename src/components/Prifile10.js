        ...
        <a href="#" onClick={clickBack}>&#8249;</a>
                ...
                <div className='middle'>
                  ...
                  <div className='middle_ander'>
                        <div className='left'>
                            <img src={prifile_photo8}/>
                              <span>Robert John Downey Jr</span>
                              <div className='brandname'>
                              <FontAwesomeIcon icon={faSquareEnvelope} className="icon"/>
                                <span className="brand__name">Expensive Actor</span>

                              </div>
                        </div>
                        <div className='right'>
                            <p><FontAwesomeIcon icon={faYoutube} className="icon"/> Watch Testimonial</p>
                            Robert John Downey Jr. is an American actor and producer. His career has been characterized 
                            
                            
                            by critical and popular success in his youth, followed by a period of substance abuse and legal 
                            troubles, before a is those the wonder car for this issue resurgence of commercial success later 
                            in his career. <br/><br/>
                            <span>Read More..</span>
                        </div>
